...
import java.io.*;hjfbldhbluyg sfbhvk javax.swing.*;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                ...
                if (h.equals(""))
                {
                    JOptionPane.showMessageDialog(null, "Education is Mandatory");
                }
                if (i.equals(""))
                {
                    JOptionPane.showMessageDialog(null, "Job Post is Mandatory");
                }
                if (j.equals(""))
                {
                ...
                if (!Pattern.matches( "^[0-9]{10}$", ff)) 
                {
                    JOptionPane.showMessageDialog(null, "Please enter a valid phone number", "Error", JOptionPane.ERROR_MESSAGE);
                }
		if (!Pattern.matches ("^[0-9]{12}$", j)) 
                {
                    JOptionPane.showMessageDialog(null, "Please enter a valid aadhar number", "Error", JOptionPane.ERROR_MESSAGE);
                }
                
                if (!Pattern.matches("^[a-zA-Z0-9]+[@]{1}+[a-zA-Z0-9]+[.]{1}+[a-zA-Z0-9]+$", g)) 
                {
                    JOptionPane.showMessageDialog(null, "Please enter a valid email", "Error", JOptionPane.ERROR_MESSAGE);
                }
                else
                {
                String q = "insert into employeedetails4 values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"')";
