...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    void showData(String s){
        try{
            conn con = new conn();
            String str = "select * from employeedetails4 where employeeid = '"+s+"'";
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update employeedetails4 set name='"+t1.getText()+"',fathersname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email='"+t5.getText()+"',education='"+t6.getText()+"',jobpost='"+t7.getText()+"',adharnumber='"+t8.getText()+"',employeeid='"+t9.getText()+"' where employeeid='"+id_emp+"'";
